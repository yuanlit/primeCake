<template>
  <div id="app01">
    ...
    <!-- 广告区 -->
    <div class="guanggao">
      <div class="guanggao_box" v-for="(item, index) in icoImgList01" :key="index" @click="toShow(item.key,'ns')">
        <img :src="item.ImgUrl">
      </div>
    ...
    <div class="mofa-box">
      ...
      <!-- 魔发猜心tab栏 -->
      <div class="mofa-tab">
        <div v-for="(item, index) in tabClass" :key="index" @click="setTab(index)" :class="{selected:tabActive==index}">
          {{item}}</div>
      </div>
      <!-- 魔法猜心商品列表 -->
      <div class="mofa-list">
        <div class="mofa-cake" v-for="(item, index) in activeList" :key="index" @click="toShow(item.Name,'list')">
    ...
    <div class="pinzhi-box">
      <div class="pinzhi-list" v-for="(item, index) in goodsList" :key="index" @click="toShow(item.Name,'list')">
        ...
        <div class="pinzhi-detail">
          ...
          <div class="pinzhi-price">
            <div>
              ...
              <span style="color: rgb(212, 212, 212); font-size: 3.2vw; margin-left: 1.067vw;">/ {{item.Size}}</span>
            </div>
          </div>
        </div>
